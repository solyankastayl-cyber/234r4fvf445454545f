...
Base URL: https://tech-analysis-core.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://tech-analysis-core.preview.emergentagent.com').rstrip('/')
